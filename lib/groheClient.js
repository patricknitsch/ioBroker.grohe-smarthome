...
class GroheClient {
	...
	async startPressureMeasurement(locationId, roomId, applianceId) {
		return this.setApplianceCommand(locationId, roomId, applianceId, { pressure_measurement_running: true });
	}
