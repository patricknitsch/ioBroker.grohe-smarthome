		...
		return {
			...
			controlTabItems: {
				...
				startPressureMeasurement: this._setStateItem(`${fullId}.controls.startPressureMeasurement`, {
					en: 'Start pressure measurement (valve must be closed)',
					de: 'Druckmessung starten (Ventil muss geschlossen sein)',
				}),
				dividerPressure: this._dividerItem(),
				// — Snooze —
				headerSnooze: this._headerItem({ en: 'Snooze', de: 'Snooze' }),
				snoozeActive: this._boolStateItem(`${fullId}.controls.snooze.active`, {
					en: 'Snooze active',
					de: 'Snooze aktiv',
				}),
				snoozeDuration: {
					type: 'state',
					oid: `${fullId}.controls.snooze.duration`,
					foreign: true,
				...
				snoozeStart: this._setStateItem(`${fullId}.controls.snooze.start`, {
					en: 'Start snooze',
					de: 'Snooze starten',
				}),
				snoozeStop: this._setStateItem(`${fullId}.controls.snooze.stop`, {
					en: 'Stop snooze',
					de: 'Snooze beenden',
				}),
				dividerSnooze: this._dividerItem(),
				// — Water limits —
				headerWithdrawal: this._headerItem({ en: 'Water limits', de: 'Wasserlimits' }),
				withdrawalAmountLimit: {
					type: 'state',
					oid: `${fullId}.controls.withdrawalAmountLimit`,
					foreign: true,
					label: { en: 'Withdrawal amount limit (l)', de: 'Entnahmelimit (l)' },
					control: 'input',
					min: 0,
					max: 2000,
					size: FULL_WIDTH_SIZE,
				...
				dividerWithdrawal: this._dividerItem(),
				// — Sprinkler mode —
				headerSprinkler: this._headerItem({ en: 'Sprinkler mode', de: 'Bewässerungsmodus' }),
				sprinklerStartHour: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.startHour`,
					foreign: true,
					label: { en: 'Start time – h', de: 'Startzeit – Std' },
					control: 'input',
					min: 0,
					max: 23,
					sm: HALF_WIDTH_SIZE,
				...
				sprinklerStartMinute: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.startMinute`,
					foreign: true,
					label: { en: 'Start time – min', de: 'Startzeit – min' },
					control: 'input',
					min: 0,
					max: 59,
					sm: HALF_WIDTH_SIZE,
				...
				sprinklerStopHour: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.stopHour`,
					foreign: true,
					label: { en: 'Stop time – h', de: 'Stoppzeit – Std' },
					control: 'input',
					min: 0,
					max: 23,
					sm: HALF_WIDTH_SIZE,
				...
				sprinklerStopMinute: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.stopMinute`,
					foreign: true,
					label: { en: 'Stop time – min', de: 'Stoppzeit – min' },
					control: 'input',
					min: 0,
					max: 59,
					sm: HALF_WIDTH_SIZE,
				...
				sprinklerMonday: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.activeMonday`,
					foreign: true,
				...
				sprinklerTuesday: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.activeTuesday`,
					foreign: true,
				...
				sprinklerWednesday: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.activeWednesday`,
					foreign: true,
				...
				sprinklerThursday: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.activeThursday`,
					foreign: true,
				...
				sprinklerFriday: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.activeFriday`,
					foreign: true,
				...
				sprinklerSaturday: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.activeSaturday`,
					foreign: true,
				...
				sprinklerSunday: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.activeSunday`,
					foreign: true,
				...
				sprinklerSave: this._setStateItem(`${fullId}.controls.sprinkler.save`, {
					en: 'Save sprinkler settings',
					de: 'Bewässerung speichern',
				}),
			},
			hasControls: true,
		};
