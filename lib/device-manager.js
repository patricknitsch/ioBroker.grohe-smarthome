	...
	_getGuardTemplate(fullId, deviceId) {
		return {
			...
			controlTabItems: {
				...
				snoozeStart: this._setStateItem(`${fullId}.snooze.start`, {
					en: 'Start snooze',
					de: 'Snooze starten',
				}),
				snoozeStop: this._setStateItem(`${fullId}.snooze.stop`, {
					en: 'Stop snooze',
					de: 'Snooze beenden',
				}),
				...
				sprinklerStartTime: {
					type: 'state',
					oid: `${fullId}.sprinkler.startTime`,
					foreign: true,
				...
				sprinklerMonday: {
					type: 'state',
					oid: `${fullId}.sprinkler.activeMonday`,
					foreign: true,
				...
				sprinklerTuesday: {
					type: 'state',
					oid: `${fullId}.sprinkler.activeTuesday`,
					foreign: true,
				...
				sprinklerWednesday: {
					type: 'state',
					oid: `${fullId}.sprinkler.activeWednesday`,
					foreign: true,
				...
				sprinklerThursday: {
					type: 'state',
					oid: `${fullId}.sprinkler.activeThursday`,
					foreign: true,
				...
				sprinklerFriday: {
					type: 'state',
					oid: `${fullId}.sprinkler.activeFriday`,
					foreign: true,
				...
				sprinklerSaturday: {
					type: 'state',
					oid: `${fullId}.sprinkler.activeSaturday`,
					foreign: true,
				...
				sprinklerSunday: {
					type: 'state',
					oid: `${fullId}.sprinkler.activeSunday`,
					foreign: true,
