	...
	_getGuardTemplate(fullId, deviceId) {
		return {
			...
			controlTabItems: {
				...
				sprinklerStartTime: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.startTime`,
					foreign: true,
					label: { en: 'Start time (min from midnight)', de: 'Startzeit (min ab Mitternacht)' },
					control: 'input',
					min: 0,
					max: 1439,
					size: FULL_WIDTH_SIZE,
				...
				sprinklerStopTime: {
					type: 'state',
					oid: `${fullId}.controls.sprinkler.stopTime`,
					foreign: true,
					label: { en: 'Stop time (min from midnight)', de: 'Stoppzeit (min ab Mitternacht)' },
					control: 'input',
					min: 0,
					max: 1439,
					size: FULL_WIDTH_SIZE,
