...
class GroheDeviceManagement extends DeviceManagement {
	...
	async loadDevices(context) {
		...
		for (const device of adapterDevices) {
			...
			const onlineState = await this.adapter.getStateAsync(
				`${this.adapter.namespace}.${applianceId}.status.online`,
			);
			...
			context.addDevice({
				id: applianceId,
				name,
				icon: `/adapter/${this.adapter.name}/${this._getDeviceIcon(type)}`,
	...
	/**
	 * Returns the icon filename for the given appliance type.
	 *
	...
	_getDeviceIcon(type) {
		switch (type) {
			case 'SENSE':
				return 'grohe-sense.png';
			case 'SENSE_GUARD':
				return 'grohe-sense-guard.png';
			case 'BLUE_HOME':
			case 'BLUE_PROFESSIONAL':
				return 'grohe-blue.png';
			default:
				return 'grohe-smarthome.png';
		}
	}
	...
	_getGuardTemplate(fullId, deviceId) {
		return {
			...
			mainTileItems: {
				...
				flowRate: this._tileStateItem(`${fullId}.flowRate`, { en: 'Flow rate', de: 'Durchfluss' }, 'l/min'),
			...
			infoTabItems: {
				...
				flowRate: this._stateItem(`${fullId}.flowRate`, { en: 'Flow rate', de: 'Durchfluss' }, 'l/min'),
			...
			controls: [
				// — Valve —
				{ id: 'h_valve', type: 'header', label: { en: 'Valve', de: 'Ventil' } },
				{
					id: 'valveOpen',
					type: 'button',
					stateId: `${fullId}.controls.valveOpen`,
				...
				},
				{
					id: 'valveClose',
					type: 'button',
					stateId: `${fullId}.controls.valveClose`,
					label: { en: 'Close', de: 'Schließen' },
					variant: 'contained',
					color: 'secondary',
				},
				{ id: 'd1', type: 'divider' },
				// — Pressure measurement —
				{ id: 'h_pressure', type: 'header', label: { en: 'Pressure measurement', de: 'Druckmessung' } },
				{
					id: 'startPressureMeasurement',
					type: 'button',
					stateId: `${fullId}.controls.startPressureMeasurement`,
					label: { en: 'Start', de: 'Starten' },
					variant: 'contained',
					color: 'primary',
				},
				{ id: 'd2', type: 'divider' },
				// — Snooze —
				{ id: 'h_snooze', type: 'header', label: { en: 'Snooze', de: 'Snooze' } },
				{
					id: 'snoozeDuration',
					type: 'number',
					stateId: `${fullId}.controls.snooze.duration`,
				...
				},
				{
					id: 'snoozeStart',
					type: 'button',
					stateId: `${fullId}.controls.snooze.start`,
					label: { en: 'Start snooze', de: 'Snooze starten' },
					variant: 'contained',
					color: 'primary',
				},
				{
					id: 'snoozeStop',
					type: 'button',
					stateId: `${fullId}.controls.snooze.stop`,
					label: { en: 'Stop snooze', de: 'Snooze beenden' },
					variant: 'outlined',
					color: 'secondary',
				},
				{ id: 'd3', type: 'divider' },
				// — Water limits —
				{ id: 'h_water', type: 'header', label: { en: 'Water limits', de: 'Wasserlimits' } },
				{
					id: 'withdrawalAmountLimit',
					type: 'number',
					stateId: `${fullId}.controls.withdrawalAmountLimit`,
					label: { en: 'Withdrawal limit (l)', de: 'Entnahmelimit (l)' },
					min: 0,
					max: 2000,
					unit: 'l',
				},
				{ id: 'd4', type: 'divider' },
				// — Sprinkler mode —
				{ id: 'h_sprinkler', type: 'header', label: { en: 'Sprinkler mode', de: 'Bewässerungsmodus' } },
				{
					id: 'sprinklerStartHour',
					type: 'number',
					stateId: `${fullId}.controls.sprinkler.startHour`,
					label: { en: 'Start – h', de: 'Start – Std' },
					min: 0,
					max: 23,
					unit: 'h',
				},
				{
					id: 'sprinklerStartMinute',
					type: 'number',
					stateId: `${fullId}.controls.sprinkler.startMinute`,
					label: { en: 'Start – min', de: 'Start – min' },
					min: 0,
					max: 59,
					unit: 'min',
				},
				{
					id: 'sprinklerStopHour',
					type: 'number',
					stateId: `${fullId}.controls.sprinkler.stopHour`,
					label: { en: 'Stop – h', de: 'Stop – Std' },
					min: 0,
					max: 23,
					unit: 'h',
				},
				{
					id: 'sprinklerStopMinute',
					type: 'number',
					stateId: `${fullId}.controls.sprinkler.stopMinute`,
					label: { en: 'Stop – min', de: 'Stop – min' },
					min: 0,
					max: 59,
					unit: 'min',
				},
				{
					id: 'sprinklerMonday',
					type: 'switch',
					stateId: `${fullId}.controls.sprinkler.activeMonday`,
					label: { en: 'Monday', de: 'Montag' },
				},
				{
					id: 'sprinklerTuesday',
					type: 'switch',
					stateId: `${fullId}.controls.sprinkler.activeTuesday`,
					label: { en: 'Tuesday', de: 'Dienstag' },
				},
				{
					id: 'sprinklerWednesday',
					type: 'switch',
					stateId: `${fullId}.controls.sprinkler.activeWednesday`,
					label: { en: 'Wednesday', de: 'Mittwoch' },
				},
				{
					id: 'sprinklerThursday',
					type: 'switch',
					stateId: `${fullId}.controls.sprinkler.activeThursday`,
					label: { en: 'Thursday', de: 'Donnerstag' },
				},
				{
					id: 'sprinklerFriday',
					type: 'switch',
					stateId: `${fullId}.controls.sprinkler.activeFriday`,
					label: { en: 'Friday', de: 'Freitag' },
				},
				{
					id: 'sprinklerSaturday',
					type: 'switch',
					stateId: `${fullId}.controls.sprinkler.activeSaturday`,
					label: { en: 'Saturday', de: 'Samstag' },
				},
				{
					id: 'sprinklerSunday',
					type: 'switch',
					stateId: `${fullId}.controls.sprinkler.activeSunday`,
					label: { en: 'Sunday', de: 'Sonntag' },
				},
				{
					id: 'sprinklerSave',
					type: 'button',
					stateId: `${fullId}.controls.sprinkler.save`,
					label: { en: 'Save sprinkler settings', de: 'Bewässerung speichern' },
					variant: 'contained',
					color: 'primary',
				},
			],
