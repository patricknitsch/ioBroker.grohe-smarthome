...
const adapterDevices = devices.filter(device => device.type === 'device' && String(device._id || '').startsWith(prefix));
...
if (type === 'SENSE_GUARD') {
return {
temperature: this._stateItem(`${fullId}.temperature`, { en: 'Water temperature', de: 'Wassertemperatur' }, '°C'),
...
return {
remainingCo2: this._stateItem(`${fullId}.remainingCo2`, { en: 'CO₂ remaining', de: 'CO₂ verbleibend' }, '%'),
remainingFilter: this._stateItem(
`${fullId}.remainingFilter`,
{ en: 'Filter remaining', de: 'Filter verbleibend' },
'%',
),
lastMeasurement: this._stateItem(`${fullId}.lastMeasurement`, { en: 'Last measurement', de: 'Letzte Messung' }),
};
}
...
flowRate: this._stateItem(`${fullId}.flowRate`, { en: 'Flow rate', de: 'Durchfluss' }, 'l/h'),
pressure: this._stateItem(`${fullId}.pressure`, { en: 'Pressure', de: 'Druck' }, 'bar'),
dailyConsumption: this._stateItem(`${fullId}.consumption.daily`, { en: 'Daily consumption', de: 'Tagesverbrauch' }, 'l'),
