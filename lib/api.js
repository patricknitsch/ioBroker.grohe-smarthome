...
class GroheApi {
	...
	async refresh() {
		...
		// Wichtig: Copy/Paste-Whitespace entfernen
		...
		try {
			...
			if (resp.data.refresh_token) {
				this.refreshToken = String(resp.data.refresh_token).replace(/\s+/g, '');
			}

			// locals for TS strict
			...
			// ganz wichtig: Fehlgrund ausgeben (ohne Token!)
